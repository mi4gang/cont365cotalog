          ...
          <div className="flex flex-col sm:flex-row sm:flex-wrap items-stretch sm:items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
            ...
            <div className="flex gap-2 sm:gap-3">
              ...
              <div className="relative flex-1 sm:flex-none" ref={priceDropdownRef}>
                ...
                {priceDropdownOpen && (
                  <div className="catalog-filter-dropdown fixed sm:absolute top-[180px] sm:top-full mt-1 z-50 w-[calc(100vw-2rem)] sm:w-80 p-4 sm:p-5 left-1/2 -translate-x-1/2 sm:left-0 sm:translate-x-0">
