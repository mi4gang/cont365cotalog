  ...
  return (
    <div className="detail-page">
      ...
      <main className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-6 relative">
        ...
        <Link href="/" className="absolute top-0 left-3 sm:left-6 lg:left-8 inline-flex items-center gap-2 transition-colors z-10" style={{ color: 'oklch(0.869 0.022 252.894)' }}>
