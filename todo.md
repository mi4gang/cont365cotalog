...
## Глубокий анализ размытия (21.01.2026 - пятый раунд)

- [x] Поднять кнопку "Назад" ещё на такое же расстояние (top-0 → -top-1)
- [x] Проанализировать CSS код обеих страниц
- [x] Найти что catalog-page::after и detail-page::after идентичны
- [x] Добавить background + !important к catalog-page::after для усиления эффекта
- [x] Увеличить blur с 8px до 12px с !important
