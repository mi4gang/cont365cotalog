...
## Радикальное исправление архитектуры (22.01.2026)
- [x] Вынести фон ЗА ПРЕДЕЛЫ .catalog-page (в body или root-level) чтобы fixed работал правильно
- [x] Исправить кнопку "Назад" - залезает под хедер, клики не работают на мобилке

## Исправление пропавшего фона и кнопки (22.01.2026)
- [x] Вернуть фон - пропал из-за z-index: -10 (ушёл под background-color)
- [x] Улучшить кликабельность кнопки "Назад" на мобилке - увеличить область клика

## Исправление фона - убрать background-color (22.01.2026)
- [x] Убрать background-color из .catalog-page и .detail-page - он перекрывает фоновую картинку
